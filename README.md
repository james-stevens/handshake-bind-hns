...
Higher throughput resolving ICANN, Handshake and `.eth` domain names using `bind` pointed to an external [Handshake node, `hsd`](https://github.com/handshake-org/hsd)
